    ...
    <section class="content-wrapper" style="width: 100%;padding: 70px 0 0;">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Phụ huynh/Học sinh</li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-secondary"><a style="color: #fff;"
                                                href="admin.php?mod=DeleteUser&po=Ph/Hs&Idtaikhoan=<?php echo $item['Idtaikhoan'] ?>"
                                                onclick="return confirm('Bạn chắc chắn muốn xóa chứ!')">Xóa</a></button>
                                        <button class="btn btn-secondary"><a
                                                href="admin.php?mod=UpdateUser&po=Ph/Hs&Idtaikhoan=<?php echo $item['Idtaikhoan'] ?>"
